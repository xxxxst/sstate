...
export default class Store {
	 ...
	 * @param fun callback
	 */
	bind(route:string, fun:Function) {
	 ...
	 * @param fun callback
	 */
	unbind(route:string, fun:Function) {
		var arrFun = this.findBindFun(route);
	...
	private findBindFun(route:string) {
		var arr = route.split(".");
	...
	private convertOne(obj, key:string, watcher, watcherGlobal) {
		var local = this;
		var tmp = obj[key];
